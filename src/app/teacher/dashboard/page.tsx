...
import { PlusCircle, Clock, Users, ListChecks, Eye, Trash2, ShieldAlert, Megaphone, UserCog, Loader } from 'lucide-react';
...
import { collection, onSnapshot, getFirestore, deleteDoc, doc, updateDoc, writeBatch } from 'firebase/firestore';
...
export default function TeacherDashboard() {
  ...
  const handleDeleteExam = async (examId: string) => {
    ...
    // Here we should query and delete all submissions related to the exam.
    // For simplicity and since we don't have that many submissions, we will skip this step in this example.
    // In a real app, you MUST delete related submissions.
